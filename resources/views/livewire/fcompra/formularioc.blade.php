<div x-data="mifuncion()" x-init="start()"  class="bg-gray-800 h-screen mt-0 py-0">
    ...
    <div class="container mx-auto my-auto ">
            ...
            <div class=" grid grid-cols-8 grid-rows-7 py-2 gap-2 text-left mt-3">
                <div class="col-span-3 text-white bg-slate-700 px-3 py-3">
                    Datos Compra

                </div>
                <div class="col-span-2 mt-3 text-gray-300">
                    ...
                    <div class="col-span-2 text-white">
                        <label class="inline">Numero de Documento: </label>
                        <input class="text-gray-500 bg-green-200 mb-3" wire:model="numeroDoc" type="text" name="numeroDoc" id="numeroDoc" >
                    </div>
                ...
                <div class="col-span-2 text-white self-center">
                    ...
                    <div class="cols-span-1 text-gray-300">
                        ...
                        class="w-full bg-gray-500" type="number" name="precioventa" id="precioventa">
                    </div>
                    <div class="cols-span-1 text-gray-300">
                    ...
                    <div class="h-12 text-white col-span-1">
    ...
    function mifuncion() {
        return{
            ...
            subTotal:function(){
                ...
                let precio = document.querySelector('#precioventa')
            ...
            function actualizar(e){
                ...
                let valor = cantidad.value * precio.value;
